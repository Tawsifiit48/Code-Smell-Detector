...
lm_model = tf.keras.models.load_model('lm_modelRNN.keras')
gc_model = tf.keras.models.load_model('gc_modelRNN.keras')
fe_model = tf.keras.models.load_model('FeatureEnvyRNN.keras')
lm_scaler = joblib.load('lm_scalarRNN.pkl')
gc_scaler = joblib.load('gc_scalarRNN.pkl')
fe_scaler = joblib.load('FeScalerRNN.pkl')
...
def predict():
    ...
    try:
        ...
        fe_output = make_prediction(fe_scaler, fe_model, {'ATFD_method': data['ATFD_method'], 'LAA_method': data['LAA_method']})
